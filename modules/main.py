...
async def upload(bot: Client, m: Message):
    ...
    await editable.edit("🌄 Now send the Thumb url/nEg » https://ghttps://graph.org/file/419c60736fbac058c9e50.jpg \n Or if don't want thumbnail send = no")
